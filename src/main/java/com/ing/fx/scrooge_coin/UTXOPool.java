...
/**
 *  represents the current set of outstanding UTXOs
 *  and contains a map from each UTXO to its corresponding transaction output.
 *  This class contains constructors to create a new empty UTXOPool or a copy of a given UTXOPool,
 *  and methods to add and remove UTXOs from the pool,
